...
TRACK_ALIASES: dict[str, list[str]] = {
    ...
    "parsec_v2p0": ["parsec", "parsec_v2p0", "parsecv2p0", "parsec_v2.0", "parsec2.0"],
    "parsec_v2p0_2022": ["parsec_v2p0_2022", "parsecv2p0_2022", "parsec_v2.0_2022", "parsec2022", "parsec_2022"],
    "parsec_v1p2": ["parsec_v1p2", "parsecv1p2", "parsec_v1.2", "parsec1.2"],
...
TRACK_DISPLAY: list[str] = [
    ...
    "PARSEC_v2p0_2022 (discontinued upstream; kept for reproducibility)",
    "PARSEC_v1p2",
