...
**In this first released version, we assume uniform priors for $T$ and $L$ in this likelihood function following the literature [e.g., @Andrews_2013; @Pascucci_2016], and different likelihood function can be added and used in the future released versions.**
